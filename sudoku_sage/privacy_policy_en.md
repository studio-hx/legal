...
GRION ("we", "us", or "our") values your privacy and complies with applicable data protection laws including the GDPR, CCPA, and Korea's Personal Information Protection Act. This Privacy Policy explains what information the Sudoku Sage mobile app (the "Service") collects, how it is used, and your rights.
...
- Game session state (current board, timer, score, input history)
