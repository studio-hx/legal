...
GRION ("we", "us", or "our") values your privacy and complies with applicable data protection laws including the GDPR, CCPA, and Korea's Personal Information Protection Act. This Privacy Policy explains what information the Block Sage mobile app (the "Service") collects, how it is used, and your rights.
...
- Game session state (current board, palette, score, combo)
- Completion statistics (best score, blocks placed, lines cleared, average score)
...
- **Usage events**: Game start/end, block placement, line-clear combos, ad impressions, premium screen views
...
The Service uses the following third-party services. Each has its own privacy policy that applies to their data handling.

| Service | Purpose | Data Collected | Provider | Privacy Policy |
|---------|---------|----------------|----------|----------------|
...
The Service is not directed at children under 13 (or the equivalent age in your jurisdiction). If we become aware that personal information of a child under 13 has been collected, we will delete it immediately.
...
This policy may be updated due to legal or service changes. Changes will be announced within the app or on this page. If you do not object within 7 days of the change, you are deemed to have consented.
...
Under the Personal Information Protection Act of Korea, you may file complaints with:

- Personal Information Protection Commission: https://www.pipc.go.kr (Call 182)
- Privacy Violation Report Center: https://privacy.kisa.or.kr (Call 118)
- Korean National Police Agency Cyber Bureau: https://ecrm.cyber.go.kr (Call 182)
